...
export class MockOnStatusCancellationBus201Class extends MockAction {
  ...
  name(): string {
    return "on_status_cancellation_BUS_201";
  }
  get description(): string {
    return "Mock for on_status_cancellation_BUS_201";
  }
