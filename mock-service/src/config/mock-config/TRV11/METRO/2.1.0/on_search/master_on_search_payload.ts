export const masterOnSearchPayload = {
  "context": {
    "action": "on_search",
    "bap_id": "dev-automation.ondc.org",
    "bap_uri": "http://localhost:6959/api-service/ONDC:TRV11/2.1.0/buyer",
    "domain": "ONDC:TRV11",
    "location": {
      "country": {
        "code": "IND"
    ...
    "message_id": "b5c99b28-51de-47fe-baa7-5fdf1944a200",
    "timestamp": "2026-04-29T20:10:04.158Z",
    "transaction_id": "b1398f0f-f015-46c1-8e3d-e78cc8ea473e",
    "ttl": "PT30S",
    "version": "2.1.0",
    "bpp_id": "dev-automation.ondc.org",
    "bpp_uri": "http://localhost:6959/api-service/ONDC:TRV11/2.1.0/seller"
  },
  "message": {
    "catalog": {
      "descriptor": {
      ...
      "providers": [
        {
          ...
          "time": {
            "range": {
              "start": "2026-04-30T05:30:00.000Z",
              "end": "2026-04-30T23:30:00.000Z"
            }
          },
          "descriptor": {
          ...
          "items": [
            {
              ...
              "time": {
                "label": "Validity",
                "duration": "P2D",
                "timestamp": "2026-05-02T01:40:04.157Z"
              }
            },
            {
              "id": "I2",
            ...
            },
            {
              ...
              "time": {
                "label": "Validity",
                "duration": "P1D",
                "timestamp": "2026-05-01T01:40:04.157Z"
              }
            },
            {
              "id": "I6",
              ...
              "time": {
                "label": "Validity",
                "duration": "P7D",
                "timestamp": "2026-05-07T01:40:04.157Z"
              }
            },
            {
              "id": "I7",
          ...
          "tags": [
            {
              ...
              "list": [
                ...
                },
                {
                  ...
                  "value": "https://metro-transit/gtfs-static"
                },
                {
                  "descriptor": {
                    "code": "WALLET_BALANCE_CHECK",
                    "name": "The CARD_NUMBER represents the Metro card number and is used to check the wallet balance via the API."
                  },
                  "value": "https://metro-transit/wallet/balance/{CARD_NUMBER}"
                }
              ]
            }
          ]
